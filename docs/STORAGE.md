...
| | Entry point | Use for |
| --- | --- | --- |
| `InMemoryMultiplayerStore` | `@avant-garde/mastra-multiplayer/storage` | Development, tests, single-process demos |
| `LibSQLMultiplayerStore` | `@avant-garde/mastra-multiplayer/storage/libsql` | Deployment on LibSQL/SQLite/Turso |
